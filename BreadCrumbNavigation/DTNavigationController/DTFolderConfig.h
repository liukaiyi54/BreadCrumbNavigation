...
// Home image
#define kFolderItemIcon                 @""

// Folder Item Text Color
#define kFolderItemTextColor            [UIColor colorWithRed:26/255.0f green:193/255.0f blue:86/255.0f alpha:1]

// Folder Item Current Text Color
#define kFolderItemCurrentTextColor     [UIColor grayColor]
